...
async function pageTransitionLeave(GSAP = theGsap) {
 const realGsap = theGsap ?? GSAP;
 var tl = realGsap.timeline();
...
async function pageTransitionEnter(GSAP = theGsap) {
 const realGsap = theGsap ?? GSAP;
 var tl = realGsap.timeline();
...
export { pageTransitionIn, pageTransitionInBeforeMount, pageTransitionEnter, pageTransitionLeave, contentAnimation, animateDevName, scrollToSection, animateStacks }